...
export default hopeTheme({
  ...
  blog: {
    medias: {
      ...
      CSDN: ["https://blog.csdn.net/yonglang9919", "<svg class=\"icon csdn-icon\" viewBox=\"0 0 1024 1024\" xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"512\" cy=\"512\" r=\"512\" fill=\"#fff\"></circle><path d=\"m512 0c282.784 0 512 229.216 512 512s-229.216 512-512 512-512-229.216-512-512 229.216-512 512-512zm189.952 752 11.2-108.224c-31.904 9.536-100.928 16.128-147.712 16.128-134.464 0-205.728-47.296-195.328-146.304 11.584-110.688 113.152-145.696 232.64-145.696 54.784 0 122.432 8.8 151.296 18.336l13.952-113.536c-43.456-10.464-89.728-16.704-168.416-16.704-203.2 0-388.704 94.88-406.4 263.488-14.848 141.472 110.4 248.512 342.432 248.512 80.672 0 138.464-6.432 166.336-16z\" fill=\"#ce000d\"></path></svg>"],
    ...
    avatar: "/avatar.png",
    roundAvatar:false,
    description: "香港理工大学计算机科学在读本科 </br> 研究云计算架构, 人工智能",
    intro: "/myself.html",
    articlePerPage: 6,
  },
