...
actions:
  ...
  - text: ORCID 🌏
    link: https://orcid.org/0009-0009-8857-5725
    type: secondary
...
features:
  ...
  - title: Predicting energy use in construction
    icon: fa-solid fa-newspaper
    details: Extreme Gradient Boosting <br /> SCI Index, IF 3.8 <br /> PeerJ Computer Science (Journal, WOS Q2)
    link: https://peerj.com/articles/cs-1500/
